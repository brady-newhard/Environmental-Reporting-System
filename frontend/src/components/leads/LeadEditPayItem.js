...
import PayItemReportForm from '../templates/disciplines/utility/PayItemReportForm';
...
export default function LeadEditPayItem() {
  ...
  return (
    <div className="bg-black min-h-screen pt-2">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        {/* Page Header */}
        <PageHeader
          title="Lead Edit - Pay Item Report"
